...
//---------------------------------------------------------------------------//
// function GetRegionAverages Compute c1 and c2 as used in the Chan-Vese segmentation algorithm.
...
void ReinitPhi(Image<double>* phiIn, Image<double>** psiOut, double dt, double h, unsigned int numIts)
{
  if (0 == *psiOut)
